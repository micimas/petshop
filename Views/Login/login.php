...
<head>
    ...
    <title>Login</title> <!--- titiutlo para corregir --->
...
<body>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card card-body mb-3">
                                ...
                                <form class="row g-3 needs-validation" novalidate name="formLogin" id="formLogin"
                                >
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            <input id="txtEmail" name="txtEmail" class="form-control" type="email"
                                                placeholder="@ejemplo.com" autofocus required>
                                            <div class="invalid-feedback">Ingresar correctamente su correo</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <p class="small mb-0">Olvidaste tu contraseña? <a href="">ingresa</a></p>
                                    </div>
                                </form>
    ...
    <script src="assets/js/functionsLogin.js"></script>
