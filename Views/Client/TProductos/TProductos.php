		...
		<div class="flex-w flex-sb-m p-b-52">
			...
			<div class="flex-w flex-c-m m-tb-10">
				<div class="flex-c-m stext-106 cl6 size-104 bor4 pointer hov-btn3 trans-04 m-r-8 m-tb-4 js-show-filter">
					...
					<i class="icon-close-filter cl2 m-r-6 fs-15 trans-04 zmdi zmdi-btn-close dis-none"></i>
					Categoría &nbsp;
				</div>
			</div>
			<!-- Filter -->
		...
		<div class="row isotope-grid">
			...
			if (count($arrProductos) > 0) {
				for ($p = 0; $p < count($arrProductos); $p++) {
					...
					?>
					<div class="tab-pane col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
						<!-- Block2 -->

						<div class="card col-lg-4 menu-item">
							<img src="<?= $portada ?>" alt="<?= $arrProductos[$p]['nombre'] ?>" class="menu-img img-fluid">
