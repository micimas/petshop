            ...
            <div class="col-md-6">
              ...
              <div class="row">
                <div class="mb-3">
                  ...
                  <select data-live-search="true" id="listCategoria" name="listCategoria"
                    required=""></select>
                </div>
                <div class="mb-3">
                  <label for="listStatus">Estado <span class="required">*</span></label>
                  <select class="selectpicker" id="listStatus" name="listStatus" required="">
              ...
              <div class="row">
                ...
                <div class="mb-3 col-md-6">
                  <button class="btn btn-danger btn-lg btn-block" type="button" data-bs-dismiss="modal"><i
