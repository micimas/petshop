                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                            ...
                            ?>
                              <select name="listTipopago" id="listTipopago" class="form-select selectpicker" data-live-search="true" required="">
                                  <?php 
                      ...
                      <tr>
                          <td>Estado:</td>
                          <td>
                              <select name="listEstado" id="listEstado" class="form-select selectpicker" data-live-search="true" required="">
                                  <?php 
