      ...
      <div class="tile">
        ...
        <section id="sPedido" class="invoice">
            ...
            <?php if($reembolso){ ?>
              <table class="table table-sm">
                ...
                <?php if( $_SESSION['userData']['idrol'] == RCLIENTES ) { ?>
                  <tr>
                    ...
                    <td class="text-end">- <?= $importeBruto.' '.$moneda ?></td>
              ...
              <?php }else{ ?>
                  <tr>
                    <td><?= $fechaReembolso.' Reembolso para '.$nombreCliente ?></td>
                    <td class="text-end">- <?= $importeBruto.' '.$moneda ?></td>
                    <td class="text-end">- <?= $comisionPaypal.' '.$moneda ?> </td>
                    <td class="text-end">- <?= $importeNeto.' '.$moneda ?></td>
                  </tr>
                  <tr>
                    <td><?= $fechaReembolso ?> Cancelación de la comisión de PayPal</td>
                    <td class="text-end"><?= $comisionPaypal.' '.$moneda ?></td>
                    <td class="text-end">0.00 <?= $moneda ?></td>
                    <td class="text-end"><?= $comisionPaypal.' '.$moneda ?></td>
                  </tr>
                <?php } ?>
                </tbody>
              ...
              <table class="table table-sm">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-end"><?= $monto.' '.$moneda ?></td>
                    <td class="text-end"><?= $monto.' '.$moneda ?></td>
                  </tr>
                </tbody>
                <tfoot>
          ...
          <div class="row d-print-none mt-2">
            <div class="col-12 text-end"><a class="btn btn-primary" href="javascript:window.print('#sPedido');" ><i class="fa fa-print"></i> Imprimir</a></div>
          </div>
        </section>
        <?php } ?>
      </div>
