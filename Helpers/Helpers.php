<?php 
    ...
    {
        $view_header = "Views/Templates/HeaderAdmin.php";
        require_once ($view_header);
    }
    function footerAdmin($data="")
    {
        $view_footer = "Views/Templates/FooterAdmin.php";
        require_once ($view_footer);        
    }
    function navAdmin($data="")
    {
        $view_nav = "Views/Templates/NavAdmin.php";
    ...
    {
        $view_header = "Views/Templates/HeaderCliente.php";
        require_once ($view_header);
    }
    function footerCliente($data="")
    {
        $view_footer = "Views/Templates/FooterCliente.php";
        require_once ($view_footer);        
    }
    ...
    function navCliente($data=""){
        $view_footer = "Views/Templates/NavCliente.php";
        require_once ($view_footer); 
    }
